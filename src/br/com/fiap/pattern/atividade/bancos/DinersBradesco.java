...
public class DinersBradesco implements IBradesco {

	public static DinersBradesco instance = null;
	
	public static DinersBradesco getInstance(){
		if(instance == null){
			instance = new DinersBradesco();
		}
		return instance;
	}
